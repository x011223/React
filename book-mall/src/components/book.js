        ...
        return (
            <li key = { book._id } className = "book-item"
                ...
                <div className = "item-content">
                    <span className = "item-title">{ book.title ? book.title : '' }</span>
                    <span className = "item-author">{ book.author ? book.author : '' }</span>
                    <p className = "item-content-desc">{ book.shortIntro ? book.shortIntro : '' }</p>
